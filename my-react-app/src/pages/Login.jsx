  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <form onSubmit={onSubmit} className="w-full max-w-md border rounded-xl p-6 bg-white/70 backdrop-blur">
        ...
        <button className="w-full bg-brand-600 text-white rounded py-2 font-medium" type="submit">Sign in</button>
        <p className="mt-3 text-sm">
          New here? <Link className="text-brand-700 underline" to="/signup">Create an account</Link>
        </p>
      </form>
    </div>
  );
